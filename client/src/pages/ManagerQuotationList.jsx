...
const ManagerQuotationList = () => {
  const { quotations, updateQuotationStatus } = useApp();

  return (
    <div className="p-6 space-y-6 bg-slate-955 bg-slate-950 text-slate-100 min-h-[calc(100vh-64px)]">
      {/* Title */}
      <div>
                ...
                {quote.status === 'Pending' && (
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="inline-flex items-center space-x-1 border border-red-500/30 bg-red-500/5 hover:bg-red-500 hover:text-white hover:border-red-500 text-red-400 px-3 py-1.5 rounded-lg text-xs font-semibold transition duration-150"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center space-x-1 bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-1.5 rounded-lg text-xs font-semibold shadow-md active:translate-y-px transition duration-150"
                    >
